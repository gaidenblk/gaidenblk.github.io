...
const router = {
	"/projetos/alpha-edtech/exercicios-javascript/javascript-aula14/exercicio-1.html":
		function () {
			return principal(); // Certifique-se de chamar a função, não apenas retorná-la
		},
	"/projetos/alpha-edtech/exercicios-javascript/javascript-aula14/brigadeiros":
		function () {
			return brigadeiros(); // Função deve retornar um nó válido
		},
	"/projetos/alpha-edtech/exercicios-javascript/javascript-aula14/cupcakes":
		function () {
			return cupcakes(); // Função deve retornar um nó válido
		},
	"/projetos/alpha-edtech/exercicios-javascript/javascript-aula14/doces":
		function () {
